...
//! invariants". This file fuzzes [`sql_dialect_fmt_parser::parse`] with thousands of generated inputs and
...
/// touch the shared `sql-dialect-fmt-test-support` crate; the formatter harness carries its own copy.
mod gen {
    use proptest::prelude::*;
