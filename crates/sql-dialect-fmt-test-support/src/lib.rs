...
pub mod highlight {
    use sql_dialect_fmt_highlight::{highlight, HighlightKind, Highlighted};
...
pub mod lexer {
    use sql_dialect_fmt_lexer::{tokenize, Lexed, SyntaxKind};
...
pub mod parser {
    use sql_dialect_fmt_parser::{parse, Parse, SyntaxKind};
